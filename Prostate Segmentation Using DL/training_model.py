...
def training_first_test():
    ...
    # model.load_weights('E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/weights_no_augmentation.h5')

    model.summary()
    model_checkpoint = ModelCheckpoint('E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/weights_no_augmentation.h5', monitor='val_loss', save_best_only=True)
    ...
    # the batch size could be a paramter that can vary and affect the results.
    history = model.fit(X_train, y_train, batch_size = 32, epochs = 120, callbacks=call_backs, verbose=1, validation_data=(X_val, y_val))
    np.save('E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/history_no_augmentation.npy',history.history)
...
def train_with_data_augmentation():
    ...
    # model.load_weights('E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/weights_with_augmentation.h5')

    model.summary()
    from tensorflow.keras.utils import plot_model
    # plot_model(model, to_file='model.png')
    model_checkpoint = ModelCheckpoint(
        'E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/weights_with_augmentation.h5', monitor='val_loss', save_best_only=True)
    ...
    # here use_multiprocessing paramter is set to be flase because the system is throwing error due to thread issues, but you can set the parameters to be true if your system allows it.
    np.save('E:/Users/Atithi/Downloads/Project/venv/Promise12/TrainData/history_with_augmentation.npy',history.history)
